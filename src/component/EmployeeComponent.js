          ...
          <div className='card col-md-6 offset-md-3'>
            <h3 className='text-center card-header'>Employee Details</h3>
              <div className='card-body'>
                <div className='row'>
                  <p><strong>Employe FirstName : </strong>{this.state.employee.firstName}</p>
                </div>
                <div className='row'>
              ...
              <h3 className='text-center cardheader'>Department Details</h3>
              <div className='card-body'>
                <div className='row'>
                  <p><strong>Department Name</strong> : {this.state.department.departmentName}</p>
                </div>
                <div className='row'>
                  <p><strong>Depatment Description</strong> : {this.state.department.depatmentDescription}</p>
                </div>
                <div className='row'>
                  <p><strong>Department code</strong> : {this.state.department.departmentCode}</p>
                </div>
              </div>
              <h3 className='text-center cardheader'>Organization Details</h3>
              <div className='card-body'>
                <div className='row'>
                ...
                <div className='row'>
                  <p><strong>Organization CreatedAt</strong> : {this.state.organization.createdDate}</p>
                </div>
              </div>
          </div>
        </div>
